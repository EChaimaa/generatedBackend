...
import com.cc.projetX.ProjetXApplication;
import com.cc.projetX.common.SecurityParams;
import com.cc.projetX.service.facade.UserService;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = ProjetXApplication.getCtx().getBean(UserService.class);

        com.cc.projetX.bean.User myUser = userService.findByUsernameWithRoles(user.getUsername());
